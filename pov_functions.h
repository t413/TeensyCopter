 ...
 *
 */
#ifndef pov_functions_h__
#define pov_functions_h__

#if defined(__AVR_ATmega32U4__) || defined(__AVR_AT90USB1286__)
	#define POVportOUT DDRA
	#define POVport PORTA
#else
	#define POVportOUT DDRD
	#define POVport PORTD
#endif


#define writeString(s,x) w_str(PSTR(s),x)

void updatePOV(uint8_t);
void w_str(const char *s, uint8_t x);
void writeASCII(char, uint8_t);
void drawCar(uint8_t);
void drawMan(uint8_t);
void printDisplay(void);
void clearDisplay(void);

const uint8_t f7x5[][5] PROGMEM = {
//const unsigned char f7x5[][5] = {
...
const uint8_t f8x5[][5] PROGMEM = {
	...
	{0x00,0x60,0x60,0x00,0x00},  // . 0x2e 46
	{0x20,0x10,0x08,0x04,0x02},  // / 0x2f 47
	{0x7E,0xA1,0x99,0x85,0x7E},  //0,
	{0x00,0xFF,0x82,0x80,0x00},  //1,
